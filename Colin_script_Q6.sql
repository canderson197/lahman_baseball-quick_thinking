...
there is Batting and Battingpost (post season)


-xcluding rows where BOTH stolen bases and caught stealing are 0 seemed to work with sb <> 0 OR cs <> 0. I don't quite understand
